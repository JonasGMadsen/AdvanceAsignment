        ...
        private World()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    // Handle the case where nodes are missing in the XML. Skal vel slettes nu hvor man bruger doxygen?
            ...
            catch (Exception ex)
            {
                ...
                // Handle other exceptions and possibly log them. Skal vel slettes nu hvor man bruger doxygen?
